<?php
    ...
    define('__PHYRE_HEADER__', "<!DOCTYPE html><html><head><style type='text/css'>body{font-family:sans-serif; padding:10%;</style><body>");
...
private static function resolve_controller($args, $params){
    ...
    if(file_exists($controllerfile)){
        ...
        if(class_exists($controllerclass)){
         ...
         throw new PhyreException("Controller '$controllerclass' not defined in $controllerfile");
     }
 }
}
}
